...
Write-Host "== Replace TasteQuizController with optional-store version ==" -ForegroundColor Cyan
...
$dart | Set-Content -Encoding UTF8 $Controller
Write-Host "  ✓ Wrote minimal optional-store controller → $Controller (backup: .bak)" -ForegroundColor Green
