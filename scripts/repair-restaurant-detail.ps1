...
Write-Host "== Similar Eats: Repair RestaurantDetailScreen ==" -ForegroundColor Cyan
Set-Location $ProjectRoot

$target = "lib/features/recommendations/presentation/restaurant_detail_screen.dart"
...
Write-Host "  ✓ Rewrote $target" -ForegroundColor Green
