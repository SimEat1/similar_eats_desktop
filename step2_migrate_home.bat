...
echo === Step 2: Migrate to modular entry (Home + Explore) ===
...
@'; Set-Content -Encoding UTF8 lib/app.dart $c"
...
@'; Set-Content -Encoding UTF8 lib/main_modular.dart $c"
...
@'; Set-Content -Encoding UTF8 lib/features/home/home_screen.dart $c"
...
@'; Set-Content -Encoding UTF8 lib/features/explore/choose_categories_screen.dart $c"
